	.CPU Z80
	TITLE SD Mapper/Megaram Nextor driver version 1.0.4
	.relab
...
BIOS_INITXT	EQU #6C						; Inicializa SCREEN0
BIOS_CHPUT	EQU #A2						; A=char
BIOS_CLS	EQU #C3						; Chamar com A=0
...
BCID1		EQU 16
BCID2		EQU 32
NUMSD		EQU 48			; 1 se cartao 1, 2 se cartao 2
FLAGSCARTAO	EQU 49			; Flag indicando se houve mudanca ou erro de cartao
NUMBLOCOS	EQU 50			; 1 byte
TEMP		EQU 52			; 1 byte
BLOCOS1		EQU 56			; 3 bytes
BLOCOS2		EQU 60			; 3 bytes
