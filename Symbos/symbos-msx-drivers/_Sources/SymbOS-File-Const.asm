...
stoerrxdv   equ 11      ;Gerät existiert nicht
...
stodatsub   equ 26          ;  IDE Bit[0-3] -> 0=nicht partitioniert, 1-4=Primäre, 5-15=Erweiterte), Bit[4-7] -> Kanal (0=Master, 1=Slave)
